...
import com.example.janani.ANM.ANM_HRWomanActivity;
...
public class DOC_PNCHighRiskActivity extends AppCompatActivity {
       ...
       // com=rootRef.child ("accepted");
        ...
        mListView.setOnItemClickListener (new AdapterView.OnItemClickListener ( ) {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                Intent i=new Intent(DOC_PNCHighRiskActivity.this, ANM_HRWomanActivity.class);
                startActivity(i);
            }
        });
