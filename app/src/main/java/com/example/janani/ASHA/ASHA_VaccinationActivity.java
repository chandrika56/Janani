...
public class ASHA_VaccinationActivity extends AppCompatActivity {
   DatabaseReference com, rootRef,demoRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_asha_vaccination);
        ...
        mListView.setOnItemClickListener (new AdapterView.OnItemClickListener ( ) {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(ASHA_VaccinationActivity.this);
